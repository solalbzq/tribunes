    ...
    <main className="flex min-h-screen items-center bg-[#f8fafc] py-16">
      <div className="mx-auto max-w-2xl px-4 text-center">
        ...
        <p className="mt-4 text-base leading-[1.7] text-[#6b7280]">
          On te contacte dès que Tribunes est prêt au lancement.
        </p>
        ...
        <section className="mt-8 rounded-[12px] border-2 border-[#2563eb] bg-white p-6 text-left shadow-[0_1px_3px_rgba(0,0,0,0.08)] sm:p-8">
          <p className="text-lg font-bold text-[#2563eb]">🔒 Ton tarif early adopter est réservé</p>
          <p className="mt-5 text-[1.5rem] font-extrabold text-[#111827]">10€/mois à vie</p>
          <p className="mt-2 text-sm text-[#6b7280]">(au lieu de 25€/mois après lancement)</p>
        ...
        <p className="mt-6 text-[13px] leading-6 text-[#6b7280]">
          Garde un œil sur ta boîte mail — on t&apos;écrira avant d&apos;ouvrir les accès pour
          confirmer ton abonnement. Aucun prélèvement ne sera effectué sans ton accord.
        </p>
